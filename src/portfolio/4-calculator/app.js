      ...
      if (tempQ === true) {
        ...
        if (tempMult === true) {
          ...
          numbers[numbers.length] =
            parseInt(saveMult) + parseInt(saveMultPlus) * parseInt(temp);
          temp = "";
          ...
          saveMult = numbers.pop();
          numbers[numbers.length] =
            parseInt(saveMult) - parseInt(saveMultMinus) * parseInt(temp);
          temp = "";
          ...
          saveSplit = numbers.pop();
          numbers[numbers.length] =
            parseInt(saveSplit) + parseInt(saveSplitPlus) / parseInt(temp);
          temp = "";
          ...
          saveSplit = numbers.pop();
          numbers[numbers.length] =
            parseInt(saveSplit) - parseInt(saveSplitMinus) / parseInt(temp);
          temp = "";
  ...
  equally: function () {
    if (tempFirstStatus === true) {
      ...
      if (tempMult === true) {
        ...
        saveMult = numbers.pop();
        numbers[numbers.length] =
          parseInt(saveMultPlus) * parseInt(temp) + parseInt(saveMult);
      } else if (tempMultMinus === true) {
        saveMult = numbers.pop();
        numbers[numbers.length] =
          parseInt(saveMult) - parseInt(saveMultMinus) * parseInt(temp);
